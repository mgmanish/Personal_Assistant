...
USAGE = '''Usage: tweet [options] message
  This script to get recent tweets from Twitter.
  Options:
...
def GetConsumerKeyEnv():
    return os.environ.get("vikas124", None)


def GetConsumerSecretEnv():
    return os.environ.get("inshallah1@", None)


def GetAccessKeyEnv():
    return os.environ.get("k2b1hhhj2ii989789", None)


def GetAccessSecretEnv():
    return os.environ.get("NONE", None)
